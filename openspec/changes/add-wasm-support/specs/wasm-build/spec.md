...
Compile CGT tool core calculation engine (`cgt-core`) to WebAssembly for browser-based usage with JSON output, enabling privacy-preserving client-side tax calculations without server-side processing.
