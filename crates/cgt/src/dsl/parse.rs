...
use crate::model::{CurrencyAmount, Operation, Transaction};
...
/// Parse CGT DSL text. Amounts are parsed with their original currency; GBP conversion
/// is deferred to calculation time.
pub fn parse(input: &str) -> std::result::Result<Vec<Transaction>, CgtError> {
