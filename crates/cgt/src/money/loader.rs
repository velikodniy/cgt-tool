...
use crate::money::parser::{FxParseError, parse_monthly_rates};
use crate::money::types::RateSource;
use include_dir::Dir;
...
fn load_bundled_dir(dir: &Dir<'_>) -> Result<Vec<crate::money::types::RateEntry>, FxLoaderError> {
